...
CurrentPlayerWithChampions.args = {
  ...
  playerDetails: {name: 'Roidrage', id: 1, role: 'Top', champions: ['Camille', 'Volibear', 'Ornn'], isUser: true},
  showPlayerDetails: true
};
...
MidWithDetails.args = {
  ...
  playerDetails: {name: 'Roidrage', id: 1, role: 'Mid', champions: []},
  showPlayerDetails: true
};
...
JgWithDetails.args = {
  ...
  playerDetails: {name: 'Roidrage', id: 1, role: 'Jg', champions: []},
  showPlayerDetails: true
};
...
BotWithDetails.args = {
  ...
  playerDetails: {name: 'Roidrage', id: 1, role: 'Bot', champions: []},
  showPlayerDetails: true
};
...
SuppWithDetails.args = {
  ...
  playerDetails: {name: 'Roidrage', id: 1, role: 'Supp', champions: []},
  showPlayerDetails: true
};
